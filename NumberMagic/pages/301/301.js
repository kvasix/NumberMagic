(function () {
    ...
    WinJS.UI.Pages.define("/pages/301/301.html", {
        ...
        ready: function (element, options) {
            ...
            //id('pawnHeap301').addEventListener("mousedown", updateHandStatus, false);
            //id('pawnHeap302').addEventListener("mousedown", updateHandStatus, false);
    ...
    function updateHandStatus(eventInfo) {
        var heapid = parseInt(this.id.replace("pawnHeap30", "")) - 1;
    ...
    function resetPawns() {
        ...
        for (var idnum = NUM_START; idnum < NUM_START + NUM_PAWNS; idnum++) {
            ...
            pawn.className = 'pawnHeap30' + randint(1, 2);
    ...
    function placePawns() {
        var elesleft = document.getElementsByClassName("pawnHeap301");
        if (elesleft) {
        ...
        var elesright = document.getElementsByClassName("pawnHeap302");
        if (elesright) {
            for (var i = 0; i < elesright.length; i++) {
                elesright[i].style.position = "absolute";
                elesright[i].style.zindex = 0;
                elesright[i].style.left = randint(66, 93) + "%";
